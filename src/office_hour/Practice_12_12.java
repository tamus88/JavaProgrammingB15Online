...
public class Practice_12_12 {
    ...
    public static void main(String[] args) {
        ...
        int[] numbers = {1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 7, 8, 9};  // expected result: 3


        for (int j = 0; j < numbers.length; j++) {
            int count = 0;   // find out the number of appearance
            for (int i = 0; i < numbers.length; i++) {
                if (numbers[i] == numbers[j]) {
                    count++;   //adds one to to occurrence number of 1
                }
        ...
        // Assignment: write program that can decide two numbers without / operator and remainder operator %
    }
}